...
<%
    ...
    String depamt = request.getParameter("deposite");
    ...
    if (uname != null) {  
        ...
        try {
            ...
            String sql = "UPDATE user SET accno = ?, uname = ?, depamt = ?, da = ?, totalamt = ? WHERE uname = ?";  
            ...
            if (i > 0) {
                ...
                out.print("There is a problem of Deposite");
            }
...
<%
    ...
    out.println("Deposite successfully!");
    out.println("</p>");
%>
</body>
</html>
